function net = res_CVPR_initN(m, varargin)
switch m,
...
net.meta.trainOpts.learningRate = [0.01*ones(1,5) 0.001*ones(1,5) 0.0005*ones(1,5) 0.0001*ones(1,5) 0.00001*ones(1,5)] ;
net.meta.trainOpts.numEpochs = numel(net.meta.trainOpts.learningRate);

% First conv layer
block = dagnn.Conv('size',  [3 3 ninputs 32], 'hasBias', true, ...
                   'stride', 2, 'pad', [1 1 1 1]);%64
lName = 'conv0';
net.addLayer(lName, block, 'image', lName, {[lName '_f'], [lName '_b']});

add_layer_bn(net, 32, lName, 'bn0', 0.1);
...
info = add_group(opts.networkType, net, n, info, 3, 96, 2, opts);%16
info = add_group(opts.networkType, net, n, info, 3, 128, 2, opts); %8
info = add_group(opts.networkType, net, n, info, 3, 256, 2, opts); %4
info = add_group(opts.networkType, net, n, info, 3, 512, 2, opts); %2
...
info = add_groupT(opts.networkType, net, n, info, 3, 160, 0.5, opts);%32
...
info = add_groupT(opts.networkType, net, n, info, 3, 96, 0.5, opts); %256
