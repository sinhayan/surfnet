function net = res_CVPR_init(m, varargin)
switch m,
...
info = add_group(opts.networkType, net, n, info, 3, 64, 2, opts);%64
info = add_group(opts.networkType, net, n, info, 3, 96, 2, opts);%32
