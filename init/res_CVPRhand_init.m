function net = res_CVPRhand_init(m, varargin)
switch m,
...
info = add_groupT(opts.networkType, net, n, info, 3, 192, 0.5, opts);%32
info = add_groupT(opts.networkType, net, n, info, 3, 128, 0.5, opts); %64
info = add_groupT(opts.networkType, net, n, info, 3, 96, 0.5, opts); %128
info = add_groupT(opts.networkType, net, n, info, 3, 64, 0.5, opts); %256
...
block = dagnn.PdistLoss('p',2,'noRoot',true,'epsilon',1e-12) ;
